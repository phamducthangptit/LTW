...
<%@include file="headerShipper.jsp"%>
 <!-- Modal -->
    ...
    <main>
    	...
    	<a class="btn btn-success btn-lg px-3 mt-1"href="donhangdangnhan.htm"><i class="fa fa-angle-double-left" aria-hidden="true"></i>Về Danh Sách Giỏ Hàng</a>
       ...
       <ul >
       	<li class = "pb-3"> Nhân Viên Giao : <br>${nhanVien.maNV } - ${nhanVien.ho } ${nhanVien.ten }</li>
    ...
    <a class="btn btn-success btn-lg px-3"href="giaohang.htm?idGH=${gioHang.idGH}">Xác Nhận Đã Giao</a>
