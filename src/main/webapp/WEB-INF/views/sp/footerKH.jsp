        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-success border-bottom pb-3 border-light logo">12Shop</h2>
                    <ul class="list-unstyled text-light footer-link-list">
                        <li>
                            <i class="fas fa-map-marker-alt fa-fw"></i>
                            97 Đ. Man Thiện, Hiệp Phú, Thành Phố Thủ Đức
                        </li>
                        <li>
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        <li><a class="text-decoration-none" href="/BanLaptop/home/shop/search.htm?searchInput=Laptop">Laptop</a></li>
                        <li><a class="text-decoration-none" href="/BanLaptop/home/shop/search.htm?searchInput=Desktop">Desktop</a></li>
                        <li><a class="text-decoration-none" href="/BanLaptop/home/shop/search.htm?searchInput=Tablet">Tablet</a></li>
                    </ul>
                </div>
