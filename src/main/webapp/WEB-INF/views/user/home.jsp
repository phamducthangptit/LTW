				...
				<div class="container">
					<div class="row p-5">
						<div class="mx-auto col-md-8 col-lg-6 order-lg-last">
							<img class="img-fluid"
								src="<c:url value='/resource/assets/img/banner_img_01.jpg" alt=""'/>">
						</div>
			...
			<div class="carousel-item">
				<div class="container">
					<div class="row p-5">
						<div class="mx-auto col-md-8 col-lg-6 order-lg-last">
							<img class="img-fluid"
								src="<c:url value='/resource/assets/img/banner_img_02.jpg" alt=""'/>">
						</div>
						<div class="col-lg-6 mb-0 d-flex align-items-center">
			...
			<div class="carousel-item">
				<div class="container">
					<div class="row p-5">
						<div class="mx-auto col-md-8 col-lg-6 order-lg-last">
							<img class="img-fluid"
								src="<c:url value='/resource/assets/img/banner_img_03.jpg" alt=""'/>">
						</div>
						<div class="col-lg-6 mb-0 d-flex align-items-center">
							<div class="text-align-left">
